...
committed sweep (sota/sm-radical-v6-n27/comparison.md) and writes writeup/fig2_sweep_gap.png.
...
rows = []
for line in open(f"{SOTA}/sota/sm-radical-v6-n27/comparison.md"):
